 ...
 */
package com.digimart.core.constants;

/**
 * Global class for all DigimartCore constants. You can add global constants for your extension into this class.
 */
public final class DigimartCoreConstants extends GeneratedDigimartCoreConstants
{
	public static final String EXTENSIONNAME = "digimartcore";


	private DigimartCoreConstants()
	{
		//empty
	}
