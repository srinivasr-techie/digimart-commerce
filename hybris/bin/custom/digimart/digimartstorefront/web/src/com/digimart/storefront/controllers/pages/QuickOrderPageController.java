 ...
 */
package com.digimart.storefront.controllers.pages;
...
import com.digimart.storefront.controllers.ControllerConstants;
...
public class QuickOrderPageController extends AbstractPageController
{
	...
	public String getQuickOrderPage(final Model model) throws CMSItemNotFoundException 
	{
		...
		model.addAttribute("quickOrderMinRows", Integer.valueOf(Config.getInt("digimartstorefront.quick.order.rows.min", 3)));
		model.addAttribute("quickOrderMaxRows", Integer.valueOf(Config.getInt("digimartstorefront.quick.order.rows.max", 25)));
