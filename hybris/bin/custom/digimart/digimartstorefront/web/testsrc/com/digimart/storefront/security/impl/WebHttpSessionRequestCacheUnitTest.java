...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/digimartstorefront/electronics/en",
						"https://electronics.local:9002/digimartstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/digimartstorefront/electronics/en",
						"https://electronics.local:9002/digimartstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/digimartstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/digimartstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/digimartstorefront/electronics/en",
						"https://electronics.local:9002/digimartstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/digimartstorefront",
						"https://electronics.local:9002/digimartstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/digimartstorefront",
						"https://electronics.local:9002/digimartstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/digimartstorefront/electronics/en",
						"https://electronics.local:9002/digimartstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
